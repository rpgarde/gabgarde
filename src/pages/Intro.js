              ...
              <Col>
                <Card.Title>
                  <h1 className="text-burgundy">
                    <span className={introOne ? "opacity-1" : "opacity-0"}>
                      Museums and galleries professional,{" "}
                    </span>
                    <span className={introTwo ? "opacity-1" : "opacity-0"}>
                      emerging conservator,{" "}
                    </span>
                    <span className={introThree ? "opacity-1" : "opacity-0"}>
                      and visual artist based in Brisbane, Australia.
                    </span>
                  </h1>
                </Card.Title>
              </Col>
