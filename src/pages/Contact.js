                                ...
                                <Form onSubmit={handleSubmit}>
                                    <Form.Group className="mb-3" controlId="name">
                                        ...
                                        <Form.Group className="mb-3" controlId="message">
                                            ...
                                            <Button variant="outline-dark" type="submit" className = "mb-3" disabled={state.submitting}>
                                                Submit
                                            </Button>
                                </Form>
                                {state.succeeded&&(<Alert variant="success">Thank you for your message. I'll get back to you soon.</Alert>)}
                            </Card.Body>
                        </Card>
                    </Col>
                </Row>
